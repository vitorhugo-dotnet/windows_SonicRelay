...
/// <summary>
/// <see cref="IWindowLifecycleService"/> over a WinUI <see cref="Window"/>/<see cref="AppWindow"/>.
...
/// </summary>
public sealed class AppLifetimeService(Window window, Func<Task> teardownAsync) : IWindowLifecycleService
{
